...
(function (global) {
    ...
    const STRINGS = {
        vi: {
            ...
            "section.forecast_gantt_title": "📆 Forecast — UAT / Golive theo tháng",
            ...
            "section.pm_sub": "Kế hoạch dự án (Excel) + báo cáo tuần (PPT) — milestone, lịch trình, risk, tiến độ tuần.",
            ...
            "gantt.all_priority": "Tất cả Priority",
            "gantt.open_only": "Chỉ còn việc mở",
            "gantt.date_all": "Tất cả",
            "gantt.date_has": "Có date",
            "gantt.date_none": "Chưa có date",
            "th.code": "Mã CN",
